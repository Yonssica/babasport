...
<head>
    ...
    <script>
        ...
        function fqBrand(brandId) {
            window.location.href = '/search?keyword=${keyword}&sort=${sort2}&brandId=' + brandId + '&pa=${pa}&pb=${pb}';
        }
        // 根据价格区间查询
                            ...
                            <div id="J_filter" class="filter">
                                <div class="f-line top">
                                    ...
                                    <div id="J_topPage" class="f-pager">
                                        <span
                                                class="fp-text"><b>${page.pageNum}</b><em>/
                                        </em><i>${page.pages == 0 ? 1 : page.pages}</i></span>
                                        <a class="fp-prev" onclick="searchKeyword('${sort2}','${page.pageNum-1}')"
                                           href="javascript:;">&lt;</a>
                                        <a class="fp-next"
                                           onclick="searchKeyword('${sort2}','${(page.pageNum+1) < (page.pages) ?
                                                   (page.pageNum+1) : (page.pages) }')" href="javascript:;"
                                           title="使用方向键右键也可翻到下一页哦！">&gt;</a>
                                    </div>
                                    <div class="f-result-sum">共<span id="J_resCount" class="num">${page.total}</span>件商品
                                    </div>
                                    <span class="clr"></span>
                                </div>
                                <div class="f-line">
